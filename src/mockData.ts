...
export const VELCLAW_DOMAINS: VelclawDomainConfig[] = [
  {
    ...
    description: 'Miền chính của nền tảng Velclaw và cổng thương hiệu.',
    badge: 'PRIMARY PLATFORM',
    color: 'emerald',
    defaultHost: 'platform-edge.velclaw.site',
    wildcardSupported: true,
    sslStatus: 'generating',
    tlsVersion: 'TLSv1.3',
    dnsRecords: [
      { id: 'site-1', type: 'CNAME', name: 'www', content: 'velclaw.site', ttl: 300, proxied: false, status: 'propagating' },
      { id: 'site-2', type: 'CAA', name: '@', content: '0 issue "letsencrypt.org"', ttl: 3600, proxied: false, status: 'propagating' },
    ]
  },
  {
    tld: 'dev',
    domain: 'velclaw.dev',
    role: 'Developer / IDE / Docs / API',
    description: 'Miền dành cho IDE, tài liệu, SDK, API và môi trường developer.',
    badge: 'DEVELOPER',
    color: 'indigo',
    defaultHost: 'dev-edge.velclaw.dev',
    wildcardSupported: true,
    sslStatus: 'generating',
    tlsVersion: 'TLSv1.3',
    dnsRecords: [
      { id: 'dev-1', type: 'CNAME', name: 'www', content: 'velclaw.dev', ttl: 300, proxied: false, status: 'propagating' },
      { id: 'dev-2', type: 'CAA', name: '@', content: '0 issue "letsencrypt.org"', ttl: 3600, proxied: false, status: 'propagating' },
    ]
  },
  {
    tld: 'app',
    ...
    description: 'Miền cho ứng dụng người dùng, console và dịch vụ Velclaw.',
    badge: 'APPLICATION',
    color: 'rose',
    defaultHost: 'app-edge.velclaw.app',
    wildcardSupported: true,
    sslStatus: 'generating',
    tlsVersion: 'TLSv1.3',
    dnsRecords: [
      { id: 'app-1', type: 'CNAME', name: 'www', content: 'velclaw.app', ttl: 300, proxied: false, status: 'propagating' },
      { id: 'app-2', type: 'CAA', name: '@', content: '0 issue "letsencrypt.org"', ttl: 3600, proxied: false, status: 'propagating' },
    ]
  }
];
